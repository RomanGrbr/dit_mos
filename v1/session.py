...
# ── Настройки ─────────────────────────────────────────────────────────────────
PROFILE_PATH = '/home/roman/.config/google-chrome/Default'
GROUP_URL    = 'https://www.facebook.com/groups/CrimeaBeauty'
OUTPUT_FILE  = Path(__file__).parent / 'session_data.json'
PAGE_WAIT    = 5   # секунд ожидания после загрузки страницы
